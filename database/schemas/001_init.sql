...
--
-- IMPORTANTE: este script SOLO crea roles y bases de datos vacías.
-- Las tablas de dominio (users, rooms, reservations, etc.) las crea
-- cada servicio Django vía "python manage.py migrate" dentro de SU
